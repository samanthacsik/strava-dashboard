...
length(my_actvities) # 235 activities as of 11/21/2022
```
...
my_acts <- rStrava::compile_activities(my_actvities) |> 
  ...
  dplyr::select(
    ...
    name, visibility, sport_type, sport_type_alt, start_date_time_local, start_date_local,
...
#............................save data...........................
# saveRDS(wrangled_acts, here::here("data/strava_acts_2022-11-21.rds"))
# write_csv(wrangled_acts, here::here("data/strava_acts_2022-11-21.csv"))
# saveRDS(wrangled_acts, here::here("myapp/data/strava_acts_2022-11-21.rds"))
```
