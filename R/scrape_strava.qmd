...
my_acts <- rStrava::compile_activities(my_actvities) |> 
  ...
  dplyr::mutate_at(c("visibility", "sport_type", "has_heartrate", 
                     "gear_id", "athlete.id", 
  ...
  dplyr::select(
    ...
    name, visibility, sport_type, start_date_local, timezone, 
...
#............................save data...........................
# saveRDS(my_acts, here::here("data/strava_acts_2022-11-08.rds"))
# write_csv(my_acts, here::here("data/strava_acts_2022-11-08.csv"))
# saveRDS(my_acts, here::here("myapp/data/strava_acts_2022-11-08.rds"))
```
